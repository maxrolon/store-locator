...
var _nanoajax = __webpack_require__(26);

var _nanoajax2 = _interopRequireDefault(_nanoajax);

var _mockRequest = __webpack_require__(37);
...
var Map = function () {
  ...
  _createClass(Map, [{
    ...
    value: function removeMarkers() {
      this.markers.forEach(function (_ref2) {
    ...
    key: 'addMarkers',
    value: function addMarkers(req, res) {
      var _this2 = this;

      var _res$locations = res.locations,
          locations = _res$locations === undefined ? [] : _res$locations;
    ...
    value: function focusOnMarker(name) {
      var marker = this.markers.map(function (_ref3) {
    ...
    value: function updateIcons() {
      ...
      this.markers.forEach(function (_ref4) {
        var location = _ref4.location,
            marker = _ref4.marker;

        var size = _this4.iconSize(location, _this4.Map.getZoom());
        marker.setIcon({
          url: _this4.iconPath(location),
